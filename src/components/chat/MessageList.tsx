    ...
    return (
      <div className="h-full flex items-center justify-center px-4">
        <div className="flex flex-col items-center text-center">
          <div className="flex items-center justify-center w-16 h-16 rounded-3xl bg-blue-50 mb-6 shadow-sm">
            <Bot className="h-8 w-8 text-blue-600" />
          </div>
          <h2 className="text-neutral-900 font-semibold text-xl mb-3">Start a conversation to generate React components</h2>
          <p className="text-neutral-500 text-sm max-w-xs">I can help you create buttons, forms, cards, and more</p>
        </div>
      </div>
    );
  }
                              ...
                              <div key={partIndex} className="inline-flex items-center gap-2 mt-2 px-3 py-1.5 bg-neutral-50 rounded-lg text-xs font-mono border border-neutral-200">
                                {tool.state === "result" && tool.result ? (
                                  <>
                                    ...
                                    <span className="text-neutral-700">{getToolLabel(tool.toolName)}</span>
                                  </>
                                ) : (
                                  <>
